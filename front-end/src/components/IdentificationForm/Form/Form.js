...
const Form = ({ form }) => {
  ...
  const checkFirstName = () => {
    if (user_first_name.trim() === '') {
      ...
      user_first_name.trim().length < 2 ||
      user_first_name.trim().length > 30
    ) {
      refSignupFirstNameError.current.innerText =
  ...
  const checkLastName = () => {
    if (user_last_name.trim() === '') {
      ...
      user_last_name.trim().length < 2 ||
      user_last_name.trim().length > 30
    ) {
      refSignupLastNameError.current.innerText =
        ...
        <form className="form" onSubmit={signup}>
          {
            <>
              <input
                ...
                value={userSignup.user_first_name}
              ...
              <input
                ...
                value={userSignup.user_last_name}
              />
              <div
